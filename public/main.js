...
async function flipCall(event){
  ...
  try{
    ...
    console.log(results);
    cument.getElementById("choice").innerHTML ="Guess: "+results.call;
    ...
    document.getElementById("coingame").innerHTML = '<li><img src="assets/img/'+
        results.call+'.png" class="bigcoin" id="callcoin"></li><li><img src="assets/img/'+results.flip+'.png" class="bigcoin"></li><li><img src="assets/img/'+results.result+'.png" class="bigcoin"></li>';
	} catch (error) {
		console.log(error);
	}
}
